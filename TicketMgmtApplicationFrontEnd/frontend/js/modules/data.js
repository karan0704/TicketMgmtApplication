...
export const Data = {
    fetchCustomers: async () => {
        ...
        try {
            ...
            console.error('Error fetching customers:', error); // Added detailed logging
        }
    },
    ...
    fetchEngineers: async () => {
        ...
        try {
            ...
            console.error('Error fetching engineers:', error); // Added detailed logging
        }
    },
    ...
    fetchAllTickets: async () => {
        ...
        try {
            ...
            console.error('Error fetching all tickets:', error); // Added detailed logging
        }
    },
    ...
    fetchDashboardStats: async () => {
        ...
        try {
            ...
            console.error('Error fetching dashboard statistics:', error); // Added detailed logging
        }
    },
    ...
    fetchRecentActivity: async () => {
        ...
        try {
            ...
            console.error('Error fetching recent activity:', error); // Added detailed logging
        }
    }
};
